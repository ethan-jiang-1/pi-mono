...
**深意**：分层是**结构化**的——`<project_context>` 有 `path` 属性、`<available_skills>` 有 name/description/location 字段。agent 读到的是"三份可区分的结构化信息"，不是"一段混着 harness 说明、项目规则、领域知识的散文"。这对应 [04-README](../04-Self-Description/README.md) 的"分层"判据。
