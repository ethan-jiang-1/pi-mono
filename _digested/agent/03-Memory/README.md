...
> **⚠️ v0.84.2 基线说明**：3.1–3.3 已对照 v0.84.2 复核（各篇正文顶部声明"已复核至 v0.84.2"）但行号未逐篇逐行核对——关键锚点行号准确，部分行号可能因版本漂移略有偏差；3.4 描述的 agent 包 session 模型已被 v0.84.0 的 session v4 整体取代，接替分析见 3.5。
