...
> - pi：`_digested/harness/01-Architecture/{1.1,1.2,1.3,1.4}`、`_digested/harness/02-Boundaries/`、`_digested/extensions/`（`01-Core/1.2`、`02-Expansion/`）、`_digested/agent/01-Anatomy/1.4`（源码或引用统一以 `v0.85.1` / `d981de122` 为基线）。
